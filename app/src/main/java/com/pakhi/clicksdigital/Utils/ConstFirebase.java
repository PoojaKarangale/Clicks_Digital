...
public class ConstFirebase {
    ...
    public static String groupRequests="Group_requests";

    public static String groups      ="Groups";
    public static String userRequests="User_requests";
    ...
    public static String messagesList ="MessagesList";
    public static String tokens       ="Tokens";
    public static String contacts     ="Contacts";

    public static String chatRequests="Chat_Requests";
    ...
    public static final String USER_MEDIA_PATH ="User_Media";
