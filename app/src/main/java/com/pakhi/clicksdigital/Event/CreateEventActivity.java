...
public class CreateEventActivity extends AppCompatActivity {
    ...
    private String category = "Artificial Intelligence", event_type = "Offline";
    ...
    private void createEvent() {
        ...
        } else if (TextUtils.isEmpty(event_description)) {
            description.requestFocus();
            description.setError("required");
        } else if (TextUtils.isEmpty(time_duration)) {
            get_duration.requestFocus();
            get_duration.setError("required");
        } else {
            if (event_type.equals("Offline") && TextUtils.isEmpty(location)) {
